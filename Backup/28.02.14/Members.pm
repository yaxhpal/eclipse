...
use C4::Accounts;
use C4::Biblio;
use C4::SQLHelper qw(InsertInTable UpdateInTable SearchInTable GetRecordCount);
...
sub NewReg {
    my $userinfo = shift;
    my $dbh = C4::Context->dbh;
    my $user=InsertInTable("member_registration",$userinfo);
    return ( $userinfo->{'reg_id'}, $user );
}
...
sub GetRowCount {
	 ...
	 return GetRecordCount($tablename, $filters, $searchtype);
}
